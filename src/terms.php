 <!-- Illuminate Terms and Conditions -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <h4> Terms and Conditions of Usage</h4> <br>
                    <p>
                        <span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span>
                        The discussion should not be for the sake of argument rather it should be a learning process. 
                        The purpose should be solely to gain pleasure of Allah and help your fellow seekers.
                    </p>
                    <p>
                        <span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span>
                        Kindly provide evidences/reference for your statements. 
                    </p>
                    <p>
                        <span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span>
                        Kindly refrain from answering and indulging into debates beyond your expertise, i.e Caliphate, Takfeer, etc.
                    </p>
                    <p>
                        <span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span>
                    ...
                    <p>
                        <span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span>
                        Promotion of any ORGANIZATION/PERSONALITY/EVENT is not allowed.
                    </p>                 
                    </div>                    
                </div>
